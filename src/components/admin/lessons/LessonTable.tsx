...
import { MoreVertical, Pencil, Trash, ExternalLink, Award } from "lucide-react";
...
const LessonTable = ({ lessons, onEdit, onDelete, onPreview }: LessonTableProps) => {
  return (
              ...
              <TableCell className="text-right">
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end" className="bg-black/70 backdrop-blur-md border-white/10 text-white">
                    ...
                    <DropdownMenuItem onClick={() => onPreview(lesson.id)}
                      className="hover:bg-white/10 cursor-pointer">
                      <ExternalLink size={16} className="mr-2" />
                      Preview
                    </DropdownMenuItem>
                    <DropdownMenuItem onClick={() => onDelete(lesson)}
